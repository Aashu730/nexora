          ...
          <div className="mt-8 rounded-[2rem] border border-white/10 bg-white/[0.05] p-6">
            ...
            <div className="mt-6 flex flex-col gap-3 rounded-3xl border border-white/10 bg-black/20 p-3 md:flex-row">
              ...
              <button
                ...
                className="flex items-center justify-center gap-3 rounded-2xl bg-gradient-to-r from-violet-600 to-cyan-500 px-7 py-4 font-semibold transition hover:scale-105"
              >
                Analyze
                <FaArrowRight />
              </button>
